...
namespace App\Controller\Admin; // on a modifier le namespace car on a déplacer le ficheir dans admin 
...
class UserController extends Controller {
    ...
    public function getList(UserRepository $userRepo) {
        // notre repository est "injecté" en parametre de l'action (la méthode) 
